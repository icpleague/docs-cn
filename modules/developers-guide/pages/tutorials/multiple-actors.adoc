...
+
为简单起见，本教程的代码示例仅包含添加待办事项和显示已添加的待办事项列表的功能。此容器的更完整版本（具有将项目标记为完整和从列表中删除项目的附加功能）可在链接中找到:https://github.com/dfinity/examples/[examples] 存储库作为link:https: //github.com/dfinity/examples/tree/master/motoko/simple-to-do[简单的待办事项清单]。
...
* 您已按照链接:../../quickstart/local-quickstart{outfilesuffix}#download-and-install[下载并安装]中的说明下载并安装了 {sdk-short-name} 包。
